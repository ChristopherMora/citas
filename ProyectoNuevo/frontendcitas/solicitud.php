        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="--bs-primary: #691C32;--bs-primary-rgb: 105,28,50;background: var(--bs-dark);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="solicitud.html"><i class="far fa-edit"></i><span class="text-break">Registro de solicitud</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Registro de solicitud</h3>
                    <div class="row mb-3">
                        <div class="col">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="p-5">
                                                ...
                                                <form action="assets/php/registerAudiencia.php"  method="POST" class="user">
                                                    ...
                                                    <div class="mb-3"><label class="form-label">Teléfono:</label><input class="form-control form-control-user" type="tel" name="telefono" placeholder="Teléfono" required="" minlength="10" maxlength="10"></div>
                                                    <div class="mb-3"><label class="form-label">Asunto:</label><input class="form-control form-control-user" type="text" name="asunto" placeholder="Asunto"></div>
                                                    <div class="mb-3"><label class="form-label">Observaciones:</label><input class="form-control form-control-user" type="text" name="observaciones" placeholder="Observaciones"></div>
                                                    <div class="mb-3"><label class="form-label">Atendió:</label><input class="form-control form-control-user" type="text" name="atendio" placeholder="Atendió"></div>
                                                    <div class="mb-3"><label class="form-label">Correo electrónico:</label><input class="form-control form-control-user" type="email" aria-describedby="emailHelp" placeholder="Correo electrónico" name="email"></div><button class="btn btn-primary d-block btn-user w-100" type="submit">Registrar solicitud de audiencia</button>
                                                    <hr>
                                                </form>
                                            </div>
                                        </div>
